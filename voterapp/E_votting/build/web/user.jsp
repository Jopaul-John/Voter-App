<%-- 
    Document   : user
    Created on : Mar 12, 2017, 12:49:09 PM
    Author     : cijo
--%>
...
<script src="js/jquery-1.9.1.js"></script>
    ...
    $(document).ready(function(){
        ...
        $("#view_vote").click(function(){
            //alert("");
            $("#here").load("view_vote.jsp");
        });
        
         $("#complaint").click(function(){
            //alert("");
            $("#here").load("ComplainForm.jsp");
        });
    });
  </script>
        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li id="view_vote"><a href="#">View Vote</a></li>
              <li id="complaint"><a href="#">Submit Complaints</a></li>
