        ...
        <div class="carousel-inner">
          <div class="item active">
            ...
            <div class="carousel-caption">
              <h1>VOTE EASY</h1>
              <h2>VOTE SAFE</h2>
              <a href="#" class="btn">mMATHDAAN</a>
            </div>
          </div>
          <div class="item">
            <img src="img/best-indian-flag-wide-pics.jpg" alt=""> 
           <!--<img src="C:\Users\User\Desktop\FLAG" alt="">--> 
           <div class="carousel-caption">
              <h1>mMATHDAAN</h1>
              <h2>VOTE EASY, VOTE SAFE, SEE VOTE</h2>
  ...
  <!-- Controls -->
    ...
    <div class="container">
      <div class="featured-block">
          <form class="form-group" action="form_act.jsp" method="post">
             
              <input class="form-control" type="text"  placeholder="Aadhar" name="aadhar" value="" autofocus="" />
                    <input class="form-control" type="password" placeholder="Unique key" name="key" value="" />
